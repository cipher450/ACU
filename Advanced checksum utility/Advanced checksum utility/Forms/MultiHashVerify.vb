...
Public Class MultiHashVerify
    ...
    Sub HideHash(ByVal Yes? As Boolean)
        If Yes = False Then
            ...
            Original_RIPEMD160.Visible = False
        Else
            ...
            Original_RIPEMD160.Visible = True
        End If
    End Sub
    ...
    Sub GetHash()
        ...
        For Each File As ListViewItem In ListView1.SelectedItems
            ...
            Original_RIPEMD160.Text = Ripemd160_File(fileinfo.FullName)
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Try
            ...
            With resaultDlg
                ...
                End If
                'Original_RIPEMD160
                If Not Given_RIPEMD160.Text = Nothing Then
                    If Compare(Original_RIPEMD160.Text, Given_RIPEMD160.Text) = True Then
                        .PictureBox2.Image = My.Resources.Mini_Yes
                        YesCount = YesCount + 1
                    Else
                        .PictureBox2.Image = My.Resources.Mini_No
                        NoCount = NoCount + 1
                    End If
                Else
                ...
                If Not NoCount = 0 Then
                    If Settings.ComboBox1.SelectedIndex = 1 Then
                        ...
                        .Label6.Text = NoCount & " Hash ne correspond pas!"
                    Else
                        .PictureBox1.Image = My.Resources.Big_No
                        .Label6.Text = NoCount & " Hash doesn't match !"
                    End If
                ...
                Else
                    If Not YesCount = 0 Then
                        If Settings.ComboBox1.SelectedIndex = 1 Then
                            ...
                            .Label6.Text = "Tout les Hash correspond "
                        Else
                            .PictureBox1.Image = My.Resources.Big_Yes
                            .Label6.Text = "All Hash Match"
                        End If
