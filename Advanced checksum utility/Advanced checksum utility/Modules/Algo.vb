...
#Region "Stringe"
    ...
    Public Function Ripemd160_crp(ByVal Texte As String) As String


        Dim ripemd1601 As New RIPEMD160Managed
        ...
        ' Hachage
        TexteHache = ripemd1601.ComputeHash(TexteEnBit)
        ...
        ' Renvoi 
        Ripemd160_crp = ByteArrayToString(TexteHache)
...
#Region "File"
    ...
    Public Function Ripemd160_File(ByVal Path As String) As String
        ...
        ' Récupération de la valeur en bit du texte à hacher 
        TexteEnBit = IO.File.ReadAllBytes(Path)
        ...
        ' Renvoi 
        Ripemd160_File = ByteArrayToString(TexteHache)
    ...
    Public Function GetCRC32(ByVal sFileName As String) As String
        Try
            ...
            Loop
            Return Hex(Not (CRC32Result)).ToLower
